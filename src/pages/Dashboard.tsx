...
import { mockAppointments, mockAssignedDoctors } from "@/data/mockData";
import { Appointment, AssignedDoctor } from "@/types";
        ...
        <div className="flex items-center gap-4">
          <div>
            ...
            <Select value={chartType} onValueChange={(value: any) => setChartType(value)}>
              ...
              <SelectContent>
                <SelectItem value="reports-over-time">Appointments Over Time</SelectItem>
                <SelectItem value="category-breakdown">Specialization Breakdown</SelectItem>
                <SelectItem value="urgency-distribution">Priority Distribution</SelectItem>
                <SelectItem value="area-analysis">Hospital Analysis</SelectItem>
      ...
      <Card className="p-6">
        <div className="mb-4">
          <h3 className="text-lg font-semibold">
            {chartType === 'reports-over-time' && 'Appointments Trend Over Time'}
            {chartType === 'category-breakdown' && 'Appointments by Specialization'}
            {chartType === 'urgency-distribution' && 'Priority Level Distribution'}
            {chartType === 'area-analysis' && 'Top 10 Hospitals by Appointment Count'}
...
const Dashboard = () => {
  ...
  const [reports, setReports] = useState(mockAppointments);
  const [sortBy, setSortBy] = useState<SortOption>('none');
  const [sortOrder, setSortOrder] = useState<SortOrder>('desc');
  const [dispatchedWorkers] = useState<AssignedDoctor[]>(mockAssignedDoctors);
      ...
      <header className="bg-gradient-header text-primary-foreground shadow-government">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div>
              <h1 className="text-2xl font-government">QARE ADMIN PORTAL</h1>
              <p className="text-sm opacity-90">Digital Healthcare Platform - Admin Dashboard</p>
            </div>
        ...
        <Card className="shadow-card">
          <CardHeader>
            <div className="flex justify-between items-center">
              <CardTitle className="text-primary">Patient Appointments</CardTitle>
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <Select value={sortBy} onValueChange={handleSortChange}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="urgency">Priority</SelectItem>
                    </SelectContent>
                  </Select>
                  {sortBy !== 'none' && (
                    <Button
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead>Medical Specialization</TableHead>
