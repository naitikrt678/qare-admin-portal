      ...
      <header className="bg-gradient-header text-primary-foreground shadow-government">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-4">
            ...
            <div>
              <h1 className="text-2xl font-government">Admin Profile</h1>
              <p className="text-sm opacity-90">Healthcare Administrator Details</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Card className="shadow-card">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">Healthcare Administrator</p>
          </CardHeader>
            ...
            <div className="grid gap-4">
              ...
              <div className="flex items-center gap-3 p-3 bg-muted rounded-lg">
                ...
                <div>
                  ...
                  <p className="font-medium">Healthcare Administrator</p>
                </div>
              </div>
