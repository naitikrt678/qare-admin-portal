        ...
        <CardHeader className="text-center space-y-6">
          ...
          <div className="flex justify-center">
            ...
            <div className="hidden h-20 w-full border-2 border-dashed border-muted-foreground/30 rounded-lg flex items-center justify-center">
              <span className="text-muted-foreground text-sm">QARE LOGO</span>
            </div>
          </div>
          
          <div className="space-y-2">
            <h1 className="text-2xl font-government text-primary">QARE ADMIN PORTAL</h1>
            <p className="text-muted-foreground">Digital Healthcare Platform</p>
