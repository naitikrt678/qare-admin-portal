      ...
      <header className="bg-gradient-header text-primary-foreground shadow-government">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center py-4">
            ...
            <div>
              <h1 className="text-2xl font-government">Appointment Details</h1>
              <p className="text-sm opacity-90">Appointment ID: {report.requestId}</p>
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="text-primary">Patient Image</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="aspect-video bg-muted rounded-lg flex items-center justify-center">
                <div className="text-center text-muted-foreground">
                  <FileText className="h-12 w-12 mx-auto mb-2" />
                  <p>Patient submitted image</p>
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <span className="text-primary">Appointment Information</span>
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="text-primary">Hospital Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
          ...
          <Card className="shadow-card">
            <CardHeader>
              <CardTitle className="text-primary">Medical Notes & Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <p className="text-sm text-muted-foreground">Medical Concern</p>
                <p className="bg-muted p-3 rounded-lg">{report.description}</p>
              </div>
              
              {report.additionalNotes && (
                <div>
                  <p className="text-sm text-muted-foreground">Additional Medical Notes</p>
